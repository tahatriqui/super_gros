...
const About = () => {
  const allArticles = [
    ...
    },
    {
      ...
      description:
        "Nos véhicules embarquent des composants dont la performance et la fiabilité sont éléves pour les différents domaines d'exploitation (Minier, Forestier, Agriculture, Energie, Marine etc).",
    },
    {
    ...
    },
    {
      ...
      description:
        "Une construction commence avec les machines professionnelles adéquats. SUPERGROS propose la solution idéale pour pratiquement chaque application. Une gamme complète de machines est à votre disposition et vous offre robustesse, puissance et efficacité.",
    },
  ];
      ...
      <section className="about-section">
        <div className="about-container">
          ...
          <motion.div
            ...
            initial={{ opacity: 0, y: -20 }} // Position initiale (invisible et un peu plus haut)
            animate={{ opacity: 1, y: 0 }} // Fin de l'animation (visible et à sa position normale)
          ...
          <motion.div
            ...
            initial={{ opacity: 0, y: 20 }} // Position initiale (invisible et un peu plus bas)
            animate={{ opacity: 1, y: 0 }} // Fin de l'animation (visible et à sa position normale)
          ...
          <div className="articles-grid">
            {allArticles.slice(0, visibleArticles).map((article, index) => (
              <motion.div
                ...
                key={index}
                initial={{ opacity: 0, y: 20 }} // Position initiale (invisible et un peu plus bas)
                animate={{ opacity: 1, y: 0 }} // Fin de l'animation (visible et à sa position finale)
                transition={{
                  duration: 0.6, // Durée de l'animation
                  delay: index * 0.1, // Délai pour chaque article
                }}
              >
